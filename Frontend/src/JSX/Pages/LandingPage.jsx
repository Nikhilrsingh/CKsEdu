  ...
  return (
    ...
    >
      <div className="animate-bounce">
        <Icon className="w-8 h-8 text-indigo-400 opacity-60" />
      </div>
    </div>
  );
};
...
const PricingCard = ({
  ...
  return (
    <div
      className={`relative bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 ${
...
export default function LandingPage() {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? "dark" : ""}`}>
      <div className="bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 transition-colors duration-300">
        {/* Header */}
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-100/50 via-transparent to-purple-100/50 dark:from-indigo-900/30 dark:to-purple-900/30"></div>
          ...
          <div className="relative z-10 container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                ...
                <button className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md text-gray-900 dark:text-white px-8 py-4 rounded-lg font-semibold hover:bg-white dark:hover:bg-gray-700 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center space-x-4 mb-8">
                <span
                  className={`font-semibold ${!yearlyPricing ? "text-indigo-600 dark:text-indigo-400" : "text-gray-600 dark:text-gray-400"}`}
                >
                  Monthly
                </span>
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ${
                    yearlyPricing ? "bg-indigo-600" : "bg-gray-200"
                  }`}
                >
                  <span
                    className={`${
                      yearlyPricing ? "translate-x-6" : "translate-x-1"
              ...
              <div>
                ...
                <form className="flex">
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-white"
                  />
                  <button
                    type="submit"
